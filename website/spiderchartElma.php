        ...
        <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
            <div class="container-fluid">
                <div class="navbar-wrapper">
                    ...
                    <a class="navbar-brand" href="dashboard.php"><b>Course Outcome Percentage</b>
                    </a>
                </div>
                ...
                <div class="container-fluid">
                    ...
                    <form method="POST">
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="form-group bmd-form-group col-md-3">
                                <label for="studentID" class="bmd-label-floating">Enter Course ID</label>
                    ...
                    <div class="row d-flex justify-content-center">
                        <button onclick="poView()" style="width:200px;" class="btn rounded btn-fill btn-primary mx-4">View Spider Chart</button>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card ">
                            ...
                            if (isset($_POST['studentID']) && isset($_POST['courseID'])) {
                                ...
                                $sql = "SELECT registrationID FROM registration_t WHERE studentID = $student_id";
                                $result = mysqli_query($con, $sql);
                                //store the row of registartionID
                                $row = mysqli_fetch_assoc($result);
                                //
                                $registration_id = $row['registrationID'];
                                echo $registration_id;

                                $query = "SELECT totalMarksObtained FROM student_course_performance_t WHERE registrationID = $registration_id";
                                ...
                                if ($result5) {
                                    ...
                                    echo "Total marks obtained: " . $row['totalMarksObtained'];
                                } else {
                            
                                    echo "Error fetching marks: " . mysqli_error($con);
                                }
                                ...
                                if ($row1 != null) {
                                    $marks = $row1['totalMarksObtained'];
                                    $labels = array('co1', 'co2', 'co3', 'co4');
                                    $scores = array($marks, $marks, $marks, $marks);
                                } else {
                                    echo  "handle the case when no records are found";
                                }
